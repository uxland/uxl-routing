...
const routeSelectorFactory : (sel: routingSelectorType) => (state: any) => Route = sel => createSelector(sel, routing => routing.route);
const paramsSelectorFactory: (sel: (state: any) => Route) => (state: any) => Object =sel => createSelector(sel, route => route.params);
const querySelectorFactory: (sel: (state: any) => Route) => (state: any) => string =sel => createSelector(sel, route => route.query);
